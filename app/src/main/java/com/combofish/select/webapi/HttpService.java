package com.example.select.webapi;
...
public interface HttpService {
    @POST("LoginServlet")
    @FormUrlEncoded
    Call<ResponseBody> login(@Field("passport") String passport, @Field("password") String password);

    @GET("GetAllCoursesServlet")
    Call<ResponseBody> getAllCoursesServlet();
